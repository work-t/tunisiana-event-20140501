        ...
        plugin.method = {
            ...
            setupQuiz: function() {
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        questionHTML.append('<div class="' + questionCountClass + '">Question <span class="current">' + count + '</span> / <span class="total">' + questionCount + '</span></div>');
                ...
                if (plugin.config.skipStartButton || $quizStarter.length == 0) {
					...
					if(plugin.config.hideQuizName) $quizName.fadeIn(500);
					if(plugin.config.hideQuizHeader) $quizHeader.fadeIn(500);
                }
            },
            ...
            startQuiz: function() {
                ...
                if (plugin.config.skipStartButton || $quizStarter.length == 0) {
					...
					if(plugin.config.hideQuizName) $quizName.hide();
					if(plugin.config.hideQuizHeader) $quizHeader.hide();
